...
public class ArticlePageController implements Initializable{
	...
	public VBox getVbCommentInputBox() {
		return vbCommentInputBox;
	}

	public void setVbCommentInputBox(VBox vbCommentInputBox) {
		this.vbCommentInputBox = vbCommentInputBox;
	}
    ...
    void onAddComment(ActionEvent event) {
    	...
    	}else if(!btnAddComment.isSelected()){
